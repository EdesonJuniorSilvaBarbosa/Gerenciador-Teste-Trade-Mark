...
namespace Gerenciador.BLL
{
    public class Cls_Uteis
    {
        ...
        public class ChecaForcaSenha
        {
            ...
            public string GetMensagemForcaSenha(ForcaDaSenha forcaDaSenha)
            {
                switch (forcaDaSenha)
                {
                    ...
                    case ForcaDaSenha.Aceitavel:
                        return "Senha aceitavel";
                    case ForcaDaSenha.Forte:
                        return "Senha forte";
                    case ForcaDaSenha.Segura:
                        return "Senha segura";
                    default:
                        throw new ArgumentOutOfRangeException(nameof(forcaDaSenha), forcaDaSenha, null);
                }
            }
        }
    }
